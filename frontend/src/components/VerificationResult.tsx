              ...
              <div className="mt-4 pt-4 border-t border-green-200 dark:border-green-800">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {transactionHash && transactionHash.length === 66 && transactionHash.startsWith('0x') && (
                      <a
                        href={`https://amoy.polygonscan.com/tx/${transactionHash}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-200"
                        title="View on Polygonscan (may take a few moments to appear)"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {transactionHash && transactionHash.length === 66 && transactionHash.startsWith('0x') && (
                  <div className="mt-2 text-xs text-green-600 dark:text-green-400">
                    <p>💡 If the transaction doesn't appear on Polygonscan immediately, please wait a few moments for blockchain indexing.</p>
                  </div>
                )}
              </div>
            )}
